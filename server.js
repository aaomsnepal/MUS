...
var trendingQueries = [
  'excuses ap dhillon', 'lahore guru randhawa', 'lut gaye jubin nautiyal',
  'tujhe kitna chahne lage', 'mann bharryaa b prak',
  'teri mitti arijit singh', 'pachtaoge arijit singh',
  'filhall b prak', 'pehle bih main arijit singh',
  'o mahi arijit singh', 'phir aur kya chahiye arijit singh',
  'kheriyat arijit singh', 'manike yohani',
  'masakali a r rahman', 'gerua dilwale',
  'bulleya ae dil hai mushkil', 'hamari adhuri kahani',
  'tum se hi jab we met', 'kabira yeh jawaani hai deewani',
  'dil diyan gallan tiger zinda hai', 'nashe si chadh gayi',
  'saiyyara animal', 'armaan varun dhawan',
  'bechainiyaan villa', 'heeriye jasleen royal',
  'chaleya jawan', 'jhoome jo pathaan',
  'hridayam hridayam', 'tere hawale satyaprem ki katha',
  'sajni raabta', 'teri deewani kailash kher',
  'naina da kya kasoor', 'doobey lofi',
  'mehendi laga ke rakhna ddlj', 'bole chudiyan k3g',
  'kajra re bunty aur babli', 'nagada sang dhol',
  'deewani mastani', 'malhari bajirao mastani',
  'apna time aayega gully boy', 'kar har maidaan fateh',
  'garmi student of the year 2', 'excuses',
  'apna bana le bhool bhulaiya', 'kesariya brahmastra',
  'tum hi ho aashiqui 2', 'kal ho na ho',
  'raataan lambiyan shershaah', 'channa mereya ae dil hai mushkil',
  'agar tum saath ho tamasha', 'muskurane citylights',
  'samjhawan highway', 'kyun hua 2 states',
  'tum saath ho from tamasha', 'piya aa re',
  'badtameez dil yeh jawaani hai deewani', 'london thumakda',
  'malhari bajirao mastani', 'dil chori happy bhaag jayegi',
  'Nachna Ohi Mera Laal Laal Dupatta', 'main rang sharbaton ka',
  'meherbaan bang bang', 'ji huzoori kai po che',
  'bandeya raees', 'akh lad jaave',
  'ek dil aeena', 'ghungroo war',
  'tum toh dharte chalo', 'tinku jiya raaz 2',
  'arabic kuthu', 'first class kalank',
  'khalibali raees', 'tera ghata kriti k',
  'kamariya stree', 'aankh marey simmba',
  'kala chashma baar baar dekho', 'aaj blue hai paani paani',
  'hookah bar', 'saturday saturday',
  'selfie le le re', 'desi girl',
  'munni badnam', 'fevicol se',
  'chittiyaan kalaiyaan', 'baby ko bass pasand',
  'badri ki dulhania', 'tamma tamma loge',
  'kaisi yeh yaariaan', 'moh moh ke dhaage',
  'pachtaoge', 'ae dil hai mushkil title',
  'ishq wala love', 'sun saathiya',
  'prem ratan dhan payo', 'nagada sang dhol',
  'ghoomar padmaavat', 'tilak kamariya',
  'gallan goodiyaan', 'rasode mein kaun tha',
  'lut gaye remix', 'bin tere sanam',
  'dilbar sataak', 'o saathiya',
  'bhool bhulaiya title', 'apna bana le',
  'main tera hero', 'tumhi ho bandhu',
  'ding ding dong', 'go go godfather',
  'deewangi deewangi', 'osti osti',
  'jhootha hi sahi', 'peeshe pe',
  'kabhi jo baadal barse', 'pehli dafa',
  'judaiyaan', 'mere rashke qamar',
  'accha chalta hoon', 'aapki nazron ne samjha'
];
